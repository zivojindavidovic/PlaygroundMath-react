...
const Account: React.FC = () => {
    ...
    const handleDownloadPDF = () => {
        ...
        const leftTasks = tasks.slice(0, 10);
        const rightTasks = tasks.slice(10, 20);
            ...
            <div className="container mt-4">
                ...
                <div className="row mt-4">
                    <div className="col-md-7">
                        <div className="card p-4 shadow-sm">
                            ...
                            <div className="form-check form-switch mb-3">
                                <input 
                                    ...
                                    onChange={() => setTestType(testType === "online" ? "pdf" : "online")}
                                />
                        ...
                        {testType === "pdf" && tasks.length > 0 && (
                            <div className="mt-4 border p-4 bg-white shadow-sm position-relative" style={{ height: "29.7cm", width: "21cm", padding: "20px" }}>
                                <div className="d-flex justify-content-between">
                                    <div>
                                        <strong>Ime:</strong> <span className="border-bottom d-inline-block" style={{ width: "200px" }}></span>
                                    </div>
                                    <div>
                                        <strong>Datum:</strong> <span className="border-bottom d-inline-block" style={{ width: "150px" }}></span>
                                    </div>
                                </div>
                                ...
                                <div className="row mt-3">
                                    <div className="col-md-6">
                                        {tasks.slice(0, 10).map((task, index) => (
                                            <p key={index} className="fs-5">{task}</p>
                                        ))}
                                    </div>
                                    <div className="col-md-6">
                                        {tasks.slice(10, 20).map((task, index) => (
                                            <p key={index} className="fs-5">{task}</p>
                                        ))}
                                    </div>
                                </div>
