...
const Home: React.FC = () => {
    const [accounts, setAccounts] = useState<{ accountId: number, username: string, points: number }[]>([]);
        ...
        <div>
            ...
            {!isTeacher ? (
                <div className="container mt-4 d-flex justify-content-center">
                    <div className="w-50 border p-3 shadow-sm rounded bg-light">
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <button className="btn btn-success w-100" onClick={handleCreateUser}>Create User</button>
                            </div>
                        </div>
                    </div>
                </div>
